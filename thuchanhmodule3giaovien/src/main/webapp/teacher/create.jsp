...
<div class="container">
    <div class="card container px-6" style="height: 100vh">
        <h3 class="text-center" style="padding-top: 40px;">Them giao vien</h3>
        <form action="/teachers?action=create" method="post">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="hobbie" name="hobbie" required>
            </div>
            <div class="mb-3">
