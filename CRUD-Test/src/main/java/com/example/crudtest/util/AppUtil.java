    ...
    public static Object getObject(HttpServletRequest request, Class clazz) {
        ...
        while (paramNames.hasMoreElements()) {
            ...
            try {
                ...
                Object value = mapper.readValue(paramValue, (JavaType) fieldType);
        ...
        while (paramNames.hasMoreElements()) {
            ...
            try {
                ...
                if(paramName.contains("_")){
                    ...
                    Object fieldType = field.getType(); // class Name
                    Object objectChild = ((Class<?>) fieldType).newInstance(); // tạo 1 object
                    field.set(object, objectChild);
//role_id
                    Field fieldChild = ((Class<?>) fieldType).getDeclaredField(fields[1]); // field object con
